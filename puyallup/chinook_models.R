...
ggsave(here("puyallup","output","chinook0_puyallup_prediction_w_hatchery.png"), width = 6, height = 8, units = "in", dpi = 300)  
...
ggsave(here("puyallup","output","chinook0_puyallup_residuals.png"), width = 8, height = 6, units = "in", dpi = 300)  
